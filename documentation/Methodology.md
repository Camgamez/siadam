...
Wonderful, the project is comming along nicely and timely. So you start working on creating the [queries](/implementation/queries.sql) file with your team. And once you are almost done with everything, the teacher decides to ask for a fully developed dataentry program before the end of the semester. Keep in mind there's only two weeks left. This guy is just great, had he been clear about the project from the start, you would have managed time differently, now you have to rush the program before the school ends, and so you begin the [website development](Development.md), hopefully you will be able to finish on time. 